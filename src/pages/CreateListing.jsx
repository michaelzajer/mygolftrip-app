...
export default function CreateListing() {
  ...
  async function onSubmit(e) {
   ...
   let geolocation = {}
   /* this section will work if API for geocoding is working
    let location;
    ...
    px-2 mx-auto">
      ...
      <form onSubmit={onSubmit}>
        ...
        <div className="flex">
          ...
          font-medium text-sm uppercase shadow-md
          rounded hover:shadow-lg focus:shadow-lg
        ...
        onChange={onChange} placeholder="Property Name" maxLength="32"
        ...
        <div className="flex space-x-6 mb-6">
            <div>
                ...
                value={bedrooms} onChange={onChange} min='1' max='50' required
            ...
            <div>
                ...
                value={bathrooms} onChange={onChange} min='1' max='50' required
                className="w-full px-4 py-2 text-xl text-gray-700
                bg-white border border-gray-300 rounded
                transition duration-150 ease-in-out
                focus:text-gray-700 focus:bg-white 
        ...
        <div className="flex mb-6">
          ...
          <div className="flex items-center mb-6">
            <div className="">
              ...
              <input 
                ...
                value={regularPrice}
                onChange={onChange}
                min='50' max='400000000'
                required
                className="w-full px-4 py-2 text-lx text-gray-700
                by-white border border-gray-300 rounded transition
                duration-150 ease-in-out focus:text-gray-700 focus:bg-white
                focus:border-slate-600 text-center"
                 />
                 {type === 'rent' && (
                  <div className="">
                    <p className="text-md f-full whitespace-nowrap ">$ / Month
          ...
          <div className="mb-6">
            <p className="tet-lg font-semibold">Images</p>
            <p className="text-gray-600">The first image will be the cover (max 6)</p>
              ...
              type="file" id='images' onChange={onChange}
