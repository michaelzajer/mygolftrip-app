...
const [trips, setTrips] = useState([]);
  ...
  return (
    <div className="container mx-auto p-4">
      <header className="max-w-6xl mx-auto border-b rounded-lg bg-blue-600">
        {trips?.map(trip => (
          <div key={trip.id} className="mb-2 bg-blue-600 shadow overflow-hidden rounded-lg">
            <div className="px-4 sm:px-6 border-b">
              <div className="flex flex-col items-left bg-blue-600 text-white">
        ...
        <div className="text-sm flex justify-left space-x-1 px-6 pb-1 bg-blue-600 text-white" >
        <button
            onClick={() => setActiveLeaderboard('overall')}
            className="bg-blue-600 hover:bg-green-300 hover:text-blue-600 text-white rounded border border-green-300 py-1 px-2 font-semibold"
          >
            Overall
          </button>
          <button
